...
def train(hidden_dim, learning_rate, gamma):
    ...
    plt.title(f'hd={hidden_dim} lr={learning_rate} gamma={gamma}')
    plt.tight_layout()
    plt.savefig('batch1024/' + f'hd={hidden_dim}_lr={learning_rate}_gamma={gamma}.png', dpi=300)
    plt.show()
